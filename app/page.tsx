 ...
 async function handleRegisterSubmit(data: LearnerFormSubmitData) {
  ...
  const greenCardVariants = {
    ...
    animate: {
      ...
      x: [8, 9, 8],
      y: [8, 7, 8],
      transition: { duration: 6, repeat: Infinity, repeatType: "mirror" as const, delay: 0.5 }
    }
  };
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center p-6 bg-gray-50 overflow-hidden"
      style={{
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-auto">
                    <Mail
                      size={16}
                      className={`transition-colors ${fieldErrors.email ? 'text-red-500' : 'text-gray-400 group-focus-within:text-orange-500'}`}
                    />
                  </div>
                  <motion.input
                    id="email"
                    ...
                    className={`w-full pl-9 pr-3 py-2 border ${
                      fieldErrors.email
                        ...
                        : 'border-gray-300 bg-gray-50 focus:ring-orange-200 focus:border-orange-500'
                    } rounded-lg focus:ring-1 transition-all duration-200 text-sm shadow-sm`}
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock
                      size={16}
                      className={`transition-colors ${fieldErrors.password ? 'text-red-500' : 'text-gray-400 group-focus-within:text-orange-500'}`}
                    />
                  </div>
                  <motion.input
                    id="password"
