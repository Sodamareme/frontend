...
function StatPanel({
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-transform duration-300 hover:-translate-y-0.5">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-sm font-medium text-slate-500">{label}</p>
          <p className={`mt-3 text-3xl font-semibold ${tones[tone].value}`}>{value}</p>
    ...
    <div className="min-h-screen bg-[#f5f1e8]">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <section className="overflow-hidden rounded-[2rem] border border-[#e7dccb] bg-[#fbf8f2] shadow-sm">
            <div className="grid gap-8 px-6 py-8 lg:grid-cols-[1.4fr_0.8fr] lg:px-8">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 rounded-full border border-[#e9d9c0] bg-white px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-slate-500">
                  <GraduationCap className="h-3.5 w-3.5 text-[#d36b2c]" />
                  Espace apprenant
                </div>

                <div className="space-y-3">
                  <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
                    Bonjour, {learnerDetails?.firstName || "Apprenant"}
                  </h1>
                  <p className="max-w-2xl text-sm leading-6 text-slate-600 sm:text-base">
                    Un tableau de bord plus simple, plus lisible et centre sur l'essentiel :
                    votre presence, votre QR code et vos modules.
                  </p>
                </div>
          ...
          <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <StatPanel
              ...
              note={`${attendanceStats?.unjustifiedAbsentDays || 0} non justifiees`}
              icon={XCircle}
              tone="red"
            />
            <StatPanel
              ...
              note="Disponibles dans votre parcours"
              icon={BookOpen}
              tone="slate"
            />
          </section>
          ...
          <section className="grid gap-6 xl:grid-cols-[0.95fr_1.25fr]">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-medium text-slate-500">QR Code personnel</p>
                  <h2 className="mt-2 text-2xl font-semibold text-slate-900">
                    Votre acces rapide
                  </h2>
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Utilisez ce QR code pour le pointage et les services qui vous sont associes.
                  </p>
                </div>
                <div className="rounded-2xl bg-[#f3eadc] p-3 text-[#d36b2c]">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-semibold text-slate-900">
                    Modules du referentiel
                  </h2>
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Consultez les modules lies a votre formation dans un espace plus propre et plus simple.
                  </p>
                </div>
